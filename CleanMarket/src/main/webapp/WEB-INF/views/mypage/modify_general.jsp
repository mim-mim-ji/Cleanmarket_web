...
<form name="modify" id="modifyForm" method="post">
	...
	<input type="hidden" name="storeName" value="${login.storeName }">
	<input type="hidden" name="memRegdate" value="${login.memRegdate }">
	<input type="hidden" name="memType" value="${login.memType }">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<table
				...
				<tr>
					<td>
						<input type="text" class="form-control tooltipstered" readonly
								name="memFiradd"  value="${login.memFiradd}"><br>
					</td>

				</tr>

				<c:if test="${login.memSecadd != null}">
					<tr>
						<td style="text-align: left">
							<p>
				...
				<tr>
					<td style="width: 100%; text-align: center; colspan: 2;">
					<br><a class="btn form-control" href="<c:url value='/mypage'/>"
							style="cursor: pointer; margin-top: 0; height: 40px; color: white; 
							background-color: orange; border: 0px solid #388E3C; opacity: 0.8">취소</a>
					</td>
				</tr>
...
<script>
	...
	if (message == "modSuccess") {
		alert("수정이 완료되었습니다");
		location.href="/cleanmarket/mypage";
	}else if(message=="modFail"){
		alert("비밀번호가 다릅니다");
		location.href="redirect:/mypage/modify";
	}
