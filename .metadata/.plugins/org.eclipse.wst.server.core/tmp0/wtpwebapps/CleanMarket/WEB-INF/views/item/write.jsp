		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<form name="writeForm" role="form" method="post" onsubmit="return check()">
					<input type="hidden" name="memNo" value="${login.memNo}">
								...
								<div class="sc-hhaNoI buTCOV">
									<div class="sc-hokXgN hcrSpf">
										<div class="sc-gneEKw dBgbVT">
											...
											required placeholder="상품 제목을 입력해주세요.">
										</div>
								...
								<div class="sc-hhaNoI buTCOV">
									<div class="sc-cIsjWt etcNyM" >																		
										...
										<label> <input name="itemSecadd" readonly
											type="checkbox" value="${login.memSecadd }"> 주소2 : ${login.memSecadd }
										</label>
									</div>
						...
						<input type="submit" value="등록" class="btn form-control" id="itemWrite-btn"
							style="background-color: #643691; margin-top: 0; height: 40px; color: white; border: 0px solid #f78f24; opacity: 0.8">
						&nbsp;&nbsp; 
						<a class="btn form-control" href="<c:url value='/item/item_list'/>"
